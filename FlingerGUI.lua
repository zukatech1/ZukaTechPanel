local Players = game:GetService("Players") local StarterGui = game:GetService("StarterGui") local CoreGui = game:GetService("CoreGui")

local function createFlingGui() if CoreGui:FindFirstChild("FlingGUI_Integrated") then CoreGui.FlingGUI_Integrated:Destroy() end
...
local topBar: Frame = Instance.new("Frame", mainFrame)
topBar.Name = "TopBar"
topBar.Size = UDim2.new(1, 0, 0, 30)
topBar.BackgroundColor3 = Color3.fromRGB(25, 25, 35)
local topCorner: UICorner = Instance.new("UICorner", topBar)
...
flingAllButton.Position = UDim2.new(0, 10, 0, 120)
flingAllButton.BackgroundColor3 = Color3.fromRGB(150, 40, 150)
...
flingAllButton.MouseButton1Click:Connect(function()
	...
	if isFlingingAll then
		...
		flingAllButton.BackgroundColor3 = Color3.fromRGB(80, 20, 80)
